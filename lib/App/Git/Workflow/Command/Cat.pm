...
App::Git::Workflow::Command::Cat - <One-line description of module's purpose>

=head1 VERSION

This documentation refers to App::Git::Workflow::Command::Cat version 0.0.1
...
Return: App::Git::Workflow::Command::Cat -
